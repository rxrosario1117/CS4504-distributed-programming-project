...
//           String routerName = "j263-08.cse1.spsu.edu"; // ServerRouter host name
        ...
        try {
            ...
            in1 = new BufferedInputStream(Socket.getInputStream());
            AudioInputStream inAudio = AudioSystem.getAudioInputStream(in1);
            ...
            while (in1 != null) {
                if (clip.isActive()) {
                    System.out.println("Audio File player is ready");
                }
            }
            ...
            System.err.println("Audio file error in reading it");
            System.exit(1);
        }
        catch (LineUnavailableException e) {
            System.err.println("Audio file error in playing it");
            System.exit(1);
        }
